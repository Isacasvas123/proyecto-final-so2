      ...
      <html>
        ...
        <body style="font-family: Arial, sans-serif; text-align: center; background-color: #f0f4f8; padding: 50px;">
          <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); display: inline-block;">
            <h1 style="color: #2c3e50; margin-bottom: 10px;">🚀 Infraestructura DevOps Cloud - Ing Sistemas 🚀</h1>
            <p style="color: #7f8c8d; font-size: 1.2em;">Sistemas Operativos II - Entorno de Producción Functional - Proyecto Final Sistemas operativos 2</p>
